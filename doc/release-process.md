...
* Update translations, see [translation_process.md](https://github.com/mogwaipay/mogwai/blob/master/doc/translation_process.md#syncing-with-transifex)
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/mogwaipay/gitian.sigs.git
...
### Build and sign Mogwai Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit mogwai=v${VERSION} ../mogwai/contrib/gitian-descriptors/gitian-osx.yml
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [mogwai-detached-sigs](https://github.com/mogwaipay/mogwai-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Mogwai-development mailing list
