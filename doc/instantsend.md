...
This mechanism has been integrated into Bitcore-Node-Mogwai which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/mogwaipay/insight-api-mogwai#web-socket-api](https://github.com/mogwaipay/insight-api-mogwai#web-socket-api)
* API: [https://github.com/mogwaipay/insight-api-mogwai#instantsend-transactions](https://github.com/mogwaipay/insight-api-mogwai#instantsend-transactions)
...
By default, the Mogwai Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mogwai Core daemon:
