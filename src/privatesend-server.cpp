...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Mogwai related functionality
...
/*
    ...
    allow endless transaction that would bloat Mogwai and make it unusable. To
