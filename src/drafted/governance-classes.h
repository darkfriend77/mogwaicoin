 ...
 *
 *   // network
 *   CMogwaiNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.mogwai.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMogwaiNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: MogwaiNetwork
// //   -- signature requirements : Key1(User)
// class CMogwaiNetworkVariable : public CGovernanceObject
// {
// private:
