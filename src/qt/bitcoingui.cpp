    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Mogwai Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Mogwai address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mogwai: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Mogwai Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mogwai Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mogwai Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Mogwai addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mogwai addresses"));
    ...
    openAction->setStatusTip(tr("Open a mogwai: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mogwai Core help message to get a list with possible Mogwai Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Mogwai Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mogwai network", "", count));
    } else {
...
{
    QString strTitle = tr("Mogwai Core"); // default title
